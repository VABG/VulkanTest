...
public unsafe class VkDevice : IDisposable
{
    ...
    private KhrSurface KhrSurface { get; } // TODO: need to extract for multi surface support
    public SurfaceKHR Surface { get; } // TODO: need to extract for multi surface support
    ...
    private void CreateSurface(VkWindow window, Instance instance, Vk vk, out KhrSurface khrSurface, out SurfaceKHR surface)
    {

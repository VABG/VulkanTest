...
public unsafe class VkTexture : IDisposable
{
    ...
    private void CreateTextureImage()
    {
        ...
        _instance.ImageUtil.CreateImage(
            (uint)img.Width,
            (uint)img.Height,
            MipLevels,
        ...
        TransitionImageLayout(Image, Format.R8G8B8A8Srgb, ImageLayout.Undefined, ImageLayout.TransferDstOptimal, MipLevels);
        ...
        GenerateMipMaps(Image, Format.R8G8B8A8Srgb, (uint)img.Width, (uint)img.Height, MipLevels);
    }
    
       private void GenerateMipMaps(Image image, Format imageFormat, uint width, uint height, uint mipLevels)
    {
        _instance.Vk.GetPhysicalDeviceFormatProperties(_instance.Device.PhysicalDevice, imageFormat, out var formatProperties);
        ...
        var commandBuffer = _instance.CommandBufferUtil.BeginSingleTimeCommands();
        ...
        for (uint i = 1; i < mipLevels; i++)
        {
            ...
            _instance.Vk.CmdBlitImage(commandBuffer,
            ...
            _instance.Vk.CmdPipelineBarrier(commandBuffer, PipelineStageFlags.TransferBit, PipelineStageFlags.FragmentShaderBit, 0,
                0, null,
                0, null,
                1, in barrier);
